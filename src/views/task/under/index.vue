  ...
  <basic-container v-if="showView">
    <avue-crud :option="option"
      ...
      <template slot="menu" slot-scope="{row}">
        <el-button type="primary" size="small" @click="goDetail(row.tjId)">查看</el-button>
      </template>
    </avue-crud>
  </basic-container>
  <my-view v-else @back="goBack" :id="id"></my-view>
</div>
</template>
...
import {getList} from "@/api/task/under";
